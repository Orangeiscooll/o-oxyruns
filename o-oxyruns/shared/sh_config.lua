...
Config.StartLocation = vector4(316.91, -559.96, 28.74, 20.53) -- Start location for oxy run
Config.RunAmount = math.random(10, 15) -- How many drop-offs the player can make each run.
...
Config.RareLootItem = 'PUTYOURITEMHERE' -- Rare loot item
